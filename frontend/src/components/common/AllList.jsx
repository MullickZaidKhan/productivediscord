                    ...
                    <div className="w-full ">
                        ...
                        <div>
                            <div className="w-full bg-[#31333800] flex flex-col justify-center gap-4">
                                <AnimatePresence>
                                    {isLoading ? (
                                        <div className="text-sm text-[#d1d5db] py-6">Loading friends…</div>
                                    ) : isError ? (
                                        <div className="text-sm text-[#f87171] py-6">Failed to load friends.</div>
                                    ) : (
                                        FRIENDS.map((f, i) => (
                                            <motion.div
                                                key={f.name}
                                            ...
                                            >
                                                <div className="flex items-center gap-5 px-2 py-2.5">
                                                    ...
                                                    <div className="min-w-0 flex-1">
                                                        ...
                                                        <div className="text-[#949ba4] text-xs">Offline</div>
                                                    </div>
                                                    ...
                                                    <div className="flex items-center gap-1.5 shrink-0">
                                                        ...
                                                        <motion.button
                                                            ...
                                                            className="w-9 h-9 rounded-full flex items-center justify-center"
                                                        >
                                                            <MoreVertical size={17} className="text-[#b5bac1]" />
                                                        </motion.button>
                                                    </div>
                                                </div>
                                                {i < FRIENDS.length - 1 && (
