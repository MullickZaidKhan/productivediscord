  ...
  return (
    <div className="flex-1 min-h-screen bg-[#313338] flex flex-col">
      ...
      <div className="h-12 px-4 mt-3 flex items-center gap-4 border-b border-[#232428] shadow-sm">
        ...
        <div className="w-px h-6 bg-[#3e3f45] mx-1"></div>
      ...
      <div className="px-4 pt-4 pb-2">
        <div className="relative">
          <input
            type="text"
            placeholder="Search"
            className="w-full bg-[#1e1f22] text-[#949ba4] placeholder-[#949ba4] text-sm rounded-md py-1.5 pl-9 pr-3 outline-none focus:ring-0"
          />
      ...
      {/* Friends List */}
      <div className="px-2">
        <div className="flex items-center gap-3 px-3 py-1 rounded-md hover:bg-[#3e3f45] hover:bg-opacity-50 group cursor-pointer transition-colors">
          <div className="relative">
            <img 
          ...
          <div className="flex flex-col flex-1">
            <span className="text-sm font-medium text-[#f2f3f5]">Zaid</span>
          ...
          <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
            <button className="w-9 h-9 rounded-full bg-[#2b2d31] hover:bg-[#232428] flex items-center justify-center transition-colors">
