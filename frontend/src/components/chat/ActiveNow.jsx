  ...
  return (
    <div className="w-[360px] min-h-screen bg-[#2b2d31] rounded-2x p-4 hidden lg:block">
      ...
      <div className="space-y-3">
        {/* Activity 1 */}
        <div className="bg-[#111214] bg-opacity-60 rounded-lg p-3">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-semibold text-white">Zaid and Maki</span>
        ...
        <div className="bg-[#111214] bg-opacity-60 rounded-lg p-3">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-white">code discussion</span>
        ...
        <div className="bg-[#111214] bg-opacity-60 rounded-lg p-3">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-white">Kaku</span>
                <span className="text-xs text-[#949ba4]">Visual Studio Code — 41m</span>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3 mt-2 ml-1">
            <div className="w-10 h-10 rounded-lg bg-[#1e1f22] flex items-center justify-center">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-semibold text-white">Editing App.jsx</span>
